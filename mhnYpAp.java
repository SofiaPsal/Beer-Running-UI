 ...
 * @author sofia
 */
public class mhnYpAp extends javax.swing.JFrame {

    /** Creates new form mhnYpAp */
    public mhnYpAp() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Τμήμα Αποθήκης");

        jPanel1.setLayout(null);

        jTextField1.setText("Χατζηπαύλου Νικόλαος");
        jPanel1.add(jTextField1);
        jTextField1.setBounds(170, 60, 150, 30);

        jTextField2.setText("Βλάβη Οθόνης");
        jPanel1.add(jTextField2);
        jTextField2.setBounds(170, 120, 150, 30);

        jTextPane1.setText("Καλημέρα σας,\n\nΤα γραφικά της αρχικής μου οθόνης παρουσιάζουν έντονο πρόβλημα. Παρακαλώ για την άμεση αποκατάστασή της.\n\nΕυχαριστώ εκ των προτέρων.");
        jScrollPane1.setViewportView(jTextPane1);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(170, 180, 240, 130);
        ...
        jButton1.setBounds(370, 320, 110, 30);
        ...
        jButton2.setBounds(530, 380, 160, 30);
        ...
        jButton3.setBounds(40, 390, 200, 30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mhnYpAp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
